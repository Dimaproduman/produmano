		...
		<div class="gl container">
			...
			<div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-6  sc">
                        <span class="f40">Дизайнерский ремонт
по фиксированной цене
и без вашего участия</span>
<span  class="f24">Выберите один из 6 стилей.<br>
А мы разработаем проект, закупим материалы<br>
и реализуем ремонт в срок до 14 недель.</span>
					...
					<div class="col-lg-4 col-md-4 col-sm-6  scf">
						...
						<p class="zform">Расскажите о квартире</p>
							<form class="form">
								<div class="input">
								<input type="text" class="number" name="area_h" id="area_h" placeholder="Площадь квартиры, м2">
								</div>
								<input type="text" class="number" name="height_h" id="height_h" placeholder="Высота потолка, м">
								<input type="text" class="number" name="s_area_h" id="s_area_h" placeholder="Площадь санузлов, м2">
								
								<div class="input">
					
					<select name="bathrooms_type_h" id="bathrooms_type_h">
				...
				<div>
					...
					<span class="ddx2"><span>250 000<span> Р.</span>
								...
								<a href="#di" class="btn-select" data-type="individual">Выбрать стиль</a>
							</form>
